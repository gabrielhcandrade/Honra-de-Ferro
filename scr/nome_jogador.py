...
class NomeJogador:
    def __init__(self, ranking_manager: RankingManager) -> None:
        ...
        # Centralizando a caixa de input
        self.input_rect: pygame.Rect = pygame.Rect(0, 0, 500, 60) # Largura maior
    ...
    def desenhar(self, tela: pygame.Surface) -> None:
        ...
        tela.fill((30, 30, 30))
        # Posiciona o prompt acima da caixa de input
        ...
        # Centraliza o texto verticalmente e adiciona um padding à esquerda
